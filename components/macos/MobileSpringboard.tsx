...
export function MobileSpringboard() {
  ...
  return (
    <div className="fixed inset-0 z-10 flex flex-col pt-12 pb-24">
...
export function IOSStatusBar() {
  ...
  return (
    <div
      className="fixed left-0 right-0 top-0 z-[1000] flex h-11 items-end justify-between px-6 pb-1 text-xs font-semibold text-white"
